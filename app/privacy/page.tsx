...
const privacyCopyByLocale: Record<"th" | "en", PrivacyCopy> = {
  th: {
    title: "Privacy Policy",
    description: "นโยบายความเป็นส่วนตัวของเว็บไซต์ Gumon Technology สำหรับผู้ใช้งานสาธารณะ",
...
function getPrivacyCopy(locale: Locale): PrivacyCopy {
  return locale === "th" ? privacyCopyByLocale.th : privacyCopyByLocale.en;
}
...
export default async function PrivacyPage({
  ...
  return (
    <section className="ui-section">
      <BreadcrumbJsonLd items={[{ name: copy.crumb, path: "/privacy" }]} />
      <div className="ui-container max-w-4xl">
        ...
        {fallbackNotice ? (
          <div className="mt-6 rounded-xl border border-line/45 bg-bg1/55 p-4 text-sm text-mist">
            {fallbackNotice}
          </div>
        ) : null}
